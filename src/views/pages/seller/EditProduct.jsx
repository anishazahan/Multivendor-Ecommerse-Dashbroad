    ...
    <div className="px-2 lg:px-5 pt-1 ">
      <div className="w-full p-4  bg-white shadow rounded-md">
        <div className="flex justify-between items-center pb-4">
          <h1 className="text-gray-700 text-xl font-semibold">Edit Product</h1>
          <Link
            className="bg-primary hover:shadow-purple-500/50 hover:shadow-lg text-white rounded-sm px-7 py-2 my-2 "
        ...
        <div>
          <form onSubmit={update}>
            <div className="flex flex-col mb-3 md:flex-row gap-4 w-full text-gray-700">
              <div className="flex flex-col w-full gap-1">
                <label htmlFor="name">Product name</label>
                <input
                  className="px-4 py-2 focus:border-indigo-500 outline-none bg-gray-100 border border-slate-200 rounded-md text-gray-600"
                ...
                >
                  <div className="w-full px-4 py-2 fixed">
                    <input
                      ...
                      className="px-3 py-1 w-full focus:border-indigo-500 outline-none bg-white border border-slate-300 rounded-md text-gray-600 overflow-hidden"
                      type="text"
                      placeholder="search"
                    />
                  </div>
                      ...
                      allCategory.map((c, i) => (
                        <span
                          className={`px-4 py-2 hover:bg-indigo-500 hover:text-white hover:shadow-lg w-full cursor-pointer ${
                            category === c.name && "bg-primary text-white"
                          }`}
                          onClick={() => {
                            setCateShow(false);
                            setCategory(c.name);
            ...
            <div className="flex flex-col w-full gap-1 text-gray-700 mb-5">
