      ...
      <div className="flex flex-wrap w-full">
                    ...
                    <tr key={i}>
                      ...
                      >
                        <div className="flex justify-start items-center gap-3">
                          <Link className="p-[7px] bg-gray-200 rounded text-gray-700 hover:shadow-lg ">
                            <FaEdit />
                          </Link>
                          <Link className="p-[7px] bg-red-100 text-red-500 rounded hover:shadow-lg hover:shadow-red-500/50">
                            <FaTrash />
                          </Link>
                        </div>
                      </td>
        ...
        >
          <div className="w-full pl-5">
            <div className="bg-white shadow h-screen lg:h-auto px-3 py-2 lg:rounded-md text-gray-600">
              ...
              <form onSubmit={add_category}>
                <div className="flex flex-col w-full gap-1 mb-3">
                  ...
                  <input
                    ...
                    className="px-4 py-2 focus:border-gray-400 outline-none bg-gray-100 border border-slate-200 rounded-md text-gray-600"
                    type="text"
                    id="name"
                    name="category_name"
