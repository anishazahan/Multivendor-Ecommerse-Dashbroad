          ...
          <div className="w-full flex flex-wrap text-gray-500">
            ...
            <div className="w-4/12">
              <div className="px-0 md:px-5 py-2">
                ...
                <div className="flex justify-between text-sm flex-col gap-2 p-4 bg-slate-200 rounded-md">
          ...
          <div>
            <form onSubmit={submit}>
              <div className="flex gap-4 py-3">
                ...
                <button className="bg-primary hover:shadow-blue-500/50 hover:shadow-lg text-white rounded-md px-7 py-2 w-[170px] ">
                  Submit
                </button>
              </div>
            </form>
