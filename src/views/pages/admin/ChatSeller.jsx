    ...
    <div className="px-2 lg:px-5 py-2">
      <div className="w-full bg-white shadow px-4 py-4 rounded-md h-[calc(100vh-140px)]">
        <div className="flex w-full h-full relative">
          ...
          >
            <div className="w-full h-[calc(100vh-177px)] bg-gray-50 md:bg-transparent overflow-y-auto">
              <div className="flex text-xl justify-between items-center p-4 md:p-0 md:px-3 md:pb-3 text-gray-600">
                <h2>Sellers</h2>
                <span
          ...
          <div className="w-full md:w-[calc(100%-200px)] md:pl-4">
            ...
            <div className="py-4">
              <div className="bg-slate-200 h-[calc(100vh-290px)] rounded-md p-3 overflow-y-auto">
                {sellerId ? (
            ...
            <form onSubmit={send} className="flex gap-3">
              ...
              <button
                ...
                className="shadow-lg bg-primary hover:shadow-purple-500/50  text-semibold w-[75px] py-[7px] rounded-md text-white flex justify-center items-center"
              >
                Send
              </button>
            </form>
