    ...
    <div className="px-2 lg:px-5 pt-1 ">
      <div className="w-full p-4  bg-white shadow rounded-md">
        <div className="flex justify-between items-center pb-4">
          <h1 className="text-gray-600 text-xl font-semibold">Add Product</h1>
          <Link
            className="bg-primary hover:shadow-blue-500/50 hover:shadow-lg text-white rounded-sm px-7 py-2 my-2 "
        ...
        <div>
          ...
          >
            ...
            <div className="flex flex-col w-full gap-1 text-gray-600 mb-5">
            ...
            <div className="grid lg:grid-cols-4 grid-cols-1 md:grid-cols-3 sm:grid-cols-2 sm:gap-4 md:gap-4 xs:gap-4 gap-3 w-full text-gray-600 mb-4">
              {imageShow.map((img, i) => (
                <div className="h-[180px] relative">
                  ...
                  <span
                    ...
                    className="p-2 z-10 cursor-pointer bg-slate-300 hover:shadow-lg hover:shadow-slate-400/50 text-white absolute top-1 right-1 rounded-full"
                  >
                    <IoCloseSharp />
                  </span>
                </div>
              ...
              <label
                className="flex justify-center items-center flex-col h-[180px] cursor-pointer border border-dashed border-gray-500 hover:border-gray-500 w-full text-gray-500"
                htmlFor="image"
              >
                <span>
                  <BsImages />
